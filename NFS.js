...
//theme sticker reply
const NFStextWait = () => {
reply(`ᴛᴜɴɢɢᴜ sᴇʙᴇɴᴛᴀʀ..⏳`)
}
const NFStextAdmin = () => {
reply(`ғɪᴛᴜʀ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴀᴅᴍɪɴ..🤦`)
}
const NFStextAdminBot = () => {
reply(`ғɪᴛᴜʀ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴘᴇɴɢᴇᴍʙᴀɴɢ ʙᴏᴛ..🙇`)
}
const NFStextOwner = () => {
reply(`ғɪᴛᴜʀ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴀᴅᴍɪɴ & ᴏᴡɴᴇʀ ɢʀᴏᴜᴘ..🚫`)
}
const NFStextGroup = () => {
reply(`ғɪᴛᴜʀ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ɢʀᴏᴜᴘ..🗣️`)
}
const NFStextPrivate = () => {
reply(`ʟᴀᴋᴜᴋᴀɴ ᴘᴀᴅᴀ ᴏʙʀᴏʟᴀɴ ᴘʀɪʙᴀᴅɪ..👥`)
}
const NFStextNul = () => {
}
...
m.reply(`ᴊᴀɴɢᴀɴ ᴛᴀɴᴅᴀɪ ᴅɪᴀ!
ᴅɪᴀ ᴀᴋғ ${reason ? 'ᴅᴇɴɢᴀɴ ᴀʟᴀsᴀɴ: ' + ᴀʟᴀsᴀɴ : 'ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴀʟᴀsᴀɴ'}
...
await m.reply(`🎮 ᴋᴜɪs ᴍᴀᴛᴇᴍᴀᴛɪᴋᴀ 🎮\n\nᴊᴀᴡᴀʙᴀɴ ʏᴀɴɢ ʙᴇɴᴀʀ 🎉\n\nɪɴɢɪɴ ʙᴇʀᴍᴀɪɴ ʟᴀɢɪ? ᴋɪʀɪᴍ ${prefix}ᴍᴀᴛʜ ᴍᴏᴅᴇ`)
delete kuismath[m.sender.split('@')[0]]
} else m.reply('ᴊᴀᴡᴀʙᴀɴ ʏᴀɴɢ sᴀʟᴀʜ!')
}

//TicTacToe\\
this.game = this.game ? this.game : {}
let room13 = Object.values(this.game).find(room13 => room13.id && room13.game && room13.state && room13.id.startsWith('tictactoe') && [room13.game.playerX, room13.game.playerO].includes(m.sender) && room13.state == 'ʙᴇʀᴍᴀɪɴ')
if (room13) {
let ok
let isWin = !1
let isTie = !1
...
reply({
'-3': 'ᴘᴇʀᴍᴀɪɴᴀɴ ᴛᴇʟᴀʜ ʙᴇʀᴀᴋʜɪʀ',
'-2': 'ᴛɪᴅᴀᴋ sᴀʜ',
'-1': 'ᴘᴏsɪsɪ ᴛɪᴅᴀᴋ ᴠᴀʟɪᴅ',
0: 'ᴘᴏsɪsɪ ᴛɪᴅᴀᴋ ᴠᴀʟɪᴅ',
}[ok])
return !0
}
...
${isWin ? `@${winner.split('@')[0]} ᴍᴇɴᴀɴɢ!` : isTie ? `ᴘᴇʀᴍᴀɪɴᴀɴ ᴛᴇʟᴀʜ ʙᴇʀᴀᴋʜɪʀ` : `Turn ${['❌', '⭕'][1 * room13.game._currentTurn]} (@${room13.game.currentTurn.split('@')[0]})`}
...
if (!roof.pilih) NFSBotInc.sendText(roof.p, `sɪʟᴀʜᴋᴀɴ ᴘɪʟɪʜ \nʀᴏᴄᴋ🗿\nᴘᴀᴘᴇʀ📄\nScissors✂️`, m)
if (!roof.pilih2) NFSBotInc.sendText(roof.p2, `sɪʟᴀʜᴋᴀɴ ᴘɪʟɪʜ \n\nʀᴏᴄᴋ🗿\nᴘᴀᴘᴇʀ📄\nScissors✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) NFSBotInc.sendText(m.chat, `ᴋᴇᴅᴜᴀ ᴘᴇᴍᴀɪɴ ᴛɪᴅᴀᴋ ɪɴɢɪɴ ʙᴇʀᴍᴀɪɴ,\nᴅɪ ʙᴀᴛᴀʟᴋᴀɴ`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
NFSBotInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} ᴛɪᴅᴀᴋ ᴍᴇᴍɪʟɪʜ sᴜɪᴛ, ɢᴀᴍᴇ ʙᴇʀᴀᴋʜɪʀ!`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
roof.text = m.text
m.reply(`ᴋᴀᴍᴜ ᴛᴇʟᴀʜ ᴍᴇᴍɪʟɪʜ ${m.text} ${!roof.pilih2 ? `\n\nᴍᴇɴᴜɴɢɢᴜ ʟᴀᴡᴀɴ ᴜɴᴛᴜᴋ ᴍᴇᴍɪʟɪʜ` : ''}`)
if (!roof.pilih2) NFSBotInc.sendText(roof.p2, '_ʟᴀᴡᴀɴ ᴛᴇʟᴀʜ ᴍᴇᴍɪʟɪʜ_\nsᴇᴋᴀʀᴀɴɢ ɢɪʟɪʀᴀɴᴍᴜ', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`ᴋᴀᴍᴜ ᴛᴇʟᴀʜ ᴍᴇᴍɪʟɪʜ ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan untuk memilih` : ''}`)
if (!roof.pilih) NFSBotInc.sendText(roof.p, '_ʟᴀᴡᴀɴ ᴛᴇʟᴀʜ ᴍᴇᴍɪʟɪʜ_\nsᴇᴋᴀʀᴀɴɢ ɢɪʟɪʀᴀɴᴍᴜ', 0)
}
...
NFSBotInc.sendText(roof.asal, `_*ʜᴀsɪʟ ᴘᴇʀᴛᴀɴᴅɪɴɢᴀɴ*_${tie ? '\nsᴇʀɪ' : ''}

@${roof.p.split`@`[0]} (${roof.text}) ${tie ? '' : roof.p == win ? ` ᴍᴇɴᴀɴɢ \n` : ` ᴋᴀʟᴀʜ \n`}
@${roof.p2.split`@`[0]} (${roof.text2}) ${tie ? '' : roof.p2 == win ? ` ᴍᴇɴᴀɴɢ \n` : ` ᴋᴀʟᴀʜ\n`}
...
m.reply(`
ᴀɴᴅᴀ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ᴀғᴋ${user.afkReason ? ' sᴇᴛᴇʟᴀʜ: ' + user.afkReason : ''}
sᴇʟᴀᴍᴀ ${clockString(new Date - user.afkTime)}
`.trim())
user.afkTime = -1
user.afkReason = ''
}
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./NFSMedia/theme/NFS_Logo.png`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
...
let teks = `╭「 *ᴀɴᴛɪ ᴠɪᴇᴡᴏɴᴄᴇ* 」\n├ *ɴᴀᴍᴀ* : ${pushname}\n├ *ᴘᴇɴɢᴜɴᴀ* : @${m.sender.split("@")[0]}\n├ *ᴊᴀᴍ* : ${xjam}\n└ *ᴘᴇsᴀɴ* : ${m.mtype}`
NFSBotInc.sendMessage(m.chat, { text: teks, mentions: [m.sender] }, { quoted: m })
await sleep(500)
m.copyNForward(m.chat, true, {readViewOnce: true}, {quoted: m}).catch(_ => m.reply(`ᴍᴜɴɢᴋɪɴ sᴜᴅᴀʜ ᴅɪ ʙᴜᴋᴀ`))
}
...
const banRep = () => {
NFSBotInc.sendMessage(m.chat, {
text:`ᴍᴀᴀғ ᴀɴᴅᴀ ᴛᴇʟᴀʜ ᴅɪ ʙᴀɴɴᴇᴅ, sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ @${creator.split("@")[0]} ᴜɴᴛᴜᴋ ᴜɴʙᴀɴ`,
mentions: [creator],
},
{
quoted:m
...
const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./NFSMedia/theme/NFS_Logo.png'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
let gdyr = await NFSBotInc.sendMessage(from, {image: { url: Lehd.thumb } , caption: `ɴᴀᴍᴀ ᴄʜᴀɴɴᴇʟ : ${ghed.player_response.videoDetails.author}
ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ : https://youtube.com/channel/${ghed.player_response.videoDetails.channelId}
ᴊᴜᴅᴜʟ : ${Lehd.meta.title}
ᴅᴜʀᴀsɪ : ${Lehd.meta.duration}
ᴅᴇsᴋʀɪᴘsɪ : ${ghed.player_response.videoDetails.shortDescription}`}, { quoted : m })
try {
...
let gedeyeer = await NFSBotInc.sendMessage(from, { image: { url: Puxa.thumb } , caption: `ɴᴀᴍᴀ ᴄʜᴀɴɴᴇʟ : ${PlXz.player_response.videoDetails.author}
ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ : https://youtube.com/channel/${PlXz.player_response.videoDetails.channelId}
ᴊᴜᴅᴜʟ : ${Puxa.meta.title}
ᴅᴜʀᴀsɪ : ${Puxa.meta.duration}
ᴅᴇsᴋʀɪᴘsɪ : ${PlXz.player_response.videoDetails.shortDescription}`}, { quoted : m })
try {
await ytdl.getInfo(Link)
...
m.reply(`ᴍᴀᴀғ ᴀɴᴅᴀ ʙᴜᴋᴀɴ ᴘᴇɴɢɢᴜɴᴀ ᴘʀᴇᴍɪᴜᴍ 😏`)
}

async function replynsfw(teks) {
m.reply(`ғɪᴛᴜʀ 🔞 ʙᴇʟᴜᴍ ᴅɪ ᴀᴋᴛɪғᴋᴀɴ🤦\n\nᴀᴋᴛɪғᴋᴀɴ ᴅᴇɴɢᴀɴ ᴄᴀʀᴀ ᴋᴇᴛɪᴋ ᴘᴇʀɪɴᴛᴀʜ *.ɴsғᴡ ᴏɴ*`)
}
...
if (isgclink) return NFSBotInc.sendMessage(m.chat, {text: `\`\`\`「 ⚠️ᴛᴀᴜᴛᴀɴ ɢʀᴜᴘ ᴛᴇʀᴅᴇᴛᴇᴋsɪ⚠️ 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah tautan ke grup ini`})
if (isAdmins) return NFSBotInc.sendMessage(m.chat, {text: `\`\`\`「 ⚠️ᴛᴀᴜᴛᴀɴ ɢʀᴜᴘ ᴛᴇʀᴅᴇᴛᴇᴋsɪ⚠️ 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (NFSTheCreator) return NFSBotInc.sendMessage(m.chat, {text: `\`\`\`「 ⚠️ᴛᴀᴜᴛᴀɴ ɢʀᴜᴘ ᴛᴇʀᴅᴇᴛᴇᴋsɪ⚠️ 」\`\`\`\n\nPemilik telah mengirim tautan, pemilik bebas memposting tautan apa pun`})
kice = m.sender
...
NFSBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
NFSBotInc.sendMessage(from, {text:`\`\`\`「 ⚠️ᴛᴀᴜᴛᴀɴ ᴡᴀ.ᴍᴇ ᴛᴇʀᴅᴇᴛᴇᴋsɪ⚠️ 」\`\`\`\n\n@${kice.split("@")[0]} Ditendang gara-gara kirim link wa.me di grup ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
break
case '.toqr':{
if (!q) return replygcNFS('Harap sertakan tautan atau teks! yang ingi di jadikan barcode')
...
if (!q) return replygcNFS(`*Contoh :* ${prefix+command} ${global.botname}`) 
NFStextWait()
let link
...
if (!q) return replygcNFS(`*Contoh :* ${prefix+command} ɴғs | ᴏғғɪᴄɪᴀʟ`) 
NFStextWait()
let link
...
break
case '.akira': case '.akiyama': case '.ana': case '.art': case '.asuna': case '.ayuzawa': case '.boruto': case '.bts': case '.chiho': case '.chitoge': case '.cosplay': case '.cosplayloli': case '.cosplaysagiri': case '.cyber': case '.deidara': case '.doraemon': case '.elaina': case '.emilia': case '.erza': case '.exo':case '.gamewallpaper': case '.gremory': case '.hacker': case '.hestia': case '.hinata': case '.husbu': case '.inori': case '.islamic': case '.isuzu': case '.itachi': case '.itori': case '.jennie': case '.jiso': case '.justina': case '.kaga': case '.kagura': case '.kakasih': case '.kaori': case '.cartoon': case '.shortquote': case '.keneki': case '.kotori': case '.kurumi': case '.lisa': case '.loli': case '.madara': case '.megumin': case '.mikasa': case '.mikey': case '.miku': case '.minato': case '.mountain': case '.narutouzumaki': case '.neko': case '.neko2': case '.nekonime': case '.nezuko': case '.onepiece': case '.pentol': case '.pokemon': case '.programming':case '.randomnime': case '.randomnime2': case '.rize': case '.rose': case '.sagiri': case '.sakura': case '.sasuke': case '.satanic': case '.shina': case '.shinka': case '.shinomiya': case '.shizuka': case '.shota': case '.space': case '.technology': case '.tejina': case '.toukachan': case '.tsunade': case '.waifu': case '.yotsuba': case '.yuki': case '.yulibocil': case '.yumeko':{
NFStextWait()
let heyy
...
if (!AntiNsfw) return replynsfw(mess.nsfw)
NFStextWait()
var ahegaonsfw = JSON.parse(fs.readFileSync('./HostMedia/nsfw/boobs.json'))
var NFSyresult = pickRandom(ahegaonsfw)
NFSBotInc.sendMessage(m.chat, { caption: mess.success, image: { url: NFSyresult.url } }, { quoted: m })
}
break
...
if (!AntiNsfw) return replynsfw(mess.nsfw)
NFStextWait()
var ahegaonsfw = JSON.parse(fs.readFileSync('./HostMedia/nsfw/asupan.json'))
var NFSyresult = pickRandom(ahegaonsfw)
NFSBotInc.sendMessage(m.chat, { caption: mess.success, video: { url: NFSyresult.url }}, { quoted: m })
}
break
case '.asupan2': {
if (!m.isGroup) return NFStextGroup()
if (!AntiNsfw) return replynsfw(mess.nsfw)
NFStextWait()
var ahegaonsfw = JSON.parse(fs.readFileSync('./HostMedia/nsfw/asupan-la.json'))
var NFSyresult = pickRandom(ahegaonsfw)
NFSBotInc.sendMessage(m.chat, { caption: mess.success, video: { url: NFSyresult.url }}, { quoted: m })
}
break
...
break
case '.igemoji': case '.instagramemoji': {
...
break
case '.facebookemoji': case '.fbemoji': {
if (!q) return replygcNFS("Masukan emoji, max 1 emoji, misal?" + ` ${prefix + command} 😀`)
NFStextWait()
emote(q, "6")
}
...
NFSBotInc.sendMessage(m.chat, { caption: `╭────────────┈ ↷
│ ✎... 𝗫𝗡𝗫𝗫 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗
│╭────────────────╯
││📌𝗝𝘂𝗱𝘂𝗹 : ${xn.result.title}
││🎞️𝗞𝘂𝗮𝗹𝗶𝘁𝗮𝘀 : ${xn.result.quality}
│╰─────────────── ·﻿ ﻿ ﻿· ﻿ ·﻿ ✦
│ °⌜꧁༒~刀ｷ丂乃のｲ~༒꧂⌟°
│
...
break
case '.patrick': case '.patricksticker': {
...
break
case '.dogesticker': case '.dogestick': case '.doge':{
...
break
case '.lovesticker': case '.lovestick' :{
